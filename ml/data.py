...
def process_data(
    ...
    Note: depending on the type of model used, you may want to add functionality
    ...
    encoder : sklearn.preprocessing._encoders.OneHotEncoder
        Trained OneHotEncoder if training=True, otherwise returns the encoder
        passed in.
    lb : sklearn.preprocessing._label.LabelBinarizer
        Trained LabelBinarizer if training=True, otherwise returns the binarizer
        passed in.
    """
